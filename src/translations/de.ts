...
export const de: TranslationKeys = {
  ...
  learn: {
    ...
    characteristicLabel: 'Schreibe eine JA/NEIN-Frage, die für "{{correctGame}}" WAHR ist, aber NICHT für "{{wrongGame}}"',
    characteristicLabelEmpty: 'Schreibe eine JA/NEIN-Frage, die für dein Spiel WAHR ist, aber NICHT für "{{wrongGame}}"',
    characteristicHint: 'Schreibe sie als vollständige Frage. z.B.: "Ist es ein Kampfspiel?", "Hat es eine offene Welt?", "Ist es ein 2D-Spiel?"',
    characteristicPlaceholder: 'z.B.: "Ist es ein Kampfspiel?", "Hat es einen Mehrspielermodus?", "Ist es ein 2D-Plattformer?"',
    previewLabel: 'Fragenvorschau',
